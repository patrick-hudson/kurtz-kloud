...
Uploader.prototype._upload = function(err, data, file) {
  ...
  var self = this;
  var ranString = require('crypto').randomBytes(3).toString('hex');
  ranString = ranString + ".png"
  var s3Objectkey = this.keyPrefix + ranString;
  ...
  s3Object.upload(function(err) {
    ...
    file.url = "http://i.scrshot.io/"+ranString;
    self.onSuccess(file);
  });
};
